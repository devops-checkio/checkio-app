...
interface AssistanceDelayRejectModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
...
export function AssistanceDelayRejectModal({
  isOpen,
  onClose,
  onSuccess,
  assistance,
}: AssistanceDelayRejectModalProps) {
  const t = useTranslations("assistanceManagement.approval.delay.reject");
      ...
      <div className="py-4">
        <div className="bg-gray-50 p-4 rounded-lg space-y-3 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="font-medium text-gray-500">{t("details.total")}</span>
