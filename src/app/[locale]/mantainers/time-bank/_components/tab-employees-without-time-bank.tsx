...
import { useGetEmployeesWithoutTimeBank } from "@/service/mantainer.service";
...
function TabEmployeesWithoutTimeBank() {
  ...
  const { data, isLoading } = useGetEmployeesWithoutTimeBank(filter);
  ...
  const handleExcelDownload = useCallback(() => {
    ...
    downloadExcel(employees, EMPLOYEE_COLUMNS_EXCEL, {
      filename: "empleados-sin-banco-horas",
      sheetName: "Empleados sin Banco de Horas",
    });
  }, [employees]);
      ...
      {isLoading ? (
            ...
            <CHEKIOTable className="rounded-none border-0 shadow-none">
              <CHEKIOTableHeader>
                <tr>
                  ...
                  <TableHeaderCell icon={AlertCircle} label="Estado del Banco" />
                  <TableHeaderCell icon={Calendar} label="Fecha de Inicio" />
        ...
        <div className="flex flex-col items-center justify-center px-6 py-24">
          ...
          <h3 className="text-lg font-semibold text-gray-900">
            No se encontraron empleados sin banco de horas
          </h3>
          <p className="mt-1 max-w-sm text-center text-sm text-gray-500">
            Los empleados sin banco de horas configurado aparecerán aquí.
          </p>
        </div>
      ) : (
        <>
                ...
                {employees.map((emp, index) => {
                  ...
                  const fullName =
                    !isEncrypted && emp.firstName
                      ...
                      : null;
                  const empWithStartDate = emp as EmployeeWithTimeBankResponseDto & {
                    startDate?: string;
                  };
                      ...
                      <CHEKIOTableCell className="px-5 py-3.5 text-right">
                        <div className="flex justify-end gap-1">
                          ...
                          <button
                            ...
                            title="Crear banco de horas"
                            aria-label="Crear banco de horas para el empleado"
                          >
...
export default TabEmployeesWithoutTimeBank;
