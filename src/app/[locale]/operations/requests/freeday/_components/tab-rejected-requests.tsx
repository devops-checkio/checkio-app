...
import { useGetRejectedFreedayRequests } from "@/service/freeday.service";
...
export default function TabRejectedRequests() {
  const t = useTranslations("operations.requests.freeday.rejected");
  ...
  const requests = rejectedRequestsData?.data || [];
          ...
          <div className="overflow-x-auto" data-tour="freeday-table">
            ...
            <CHEKIOTableHeader>
              <tr>
                ...
                <CHEKIOTableHead>
                  {t("table.headers.rejectedAt")}
                </CHEKIOTableHead>
                <CHEKIOTableHead>
                  {t("table.headers.rejectionReason")}
                </CHEKIOTableHead>
                <CHEKIOTableHead>{t("table.headers.status")}</CHEKIOTableHead>
                {canUpdate(
