...
import { useGetApprovedOvertimeRequests } from "@/service/overtime-request.service";
...
import { ApprovedOvertimeTableHeadRow } from "./overtime-tab-table-heads";

export default function TabApprovedOvertimeRequests() {
  const t = useTranslations("operations.requests.overtime.tabs.approved");
  ...
  const { data: approvedRequestsData, isLoading } =
    useGetApprovedOvertimeRequests({
      page,
      pageSize,
      sort: "desc",
