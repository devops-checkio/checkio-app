...
import { useGetRejectedOvertimeRequests } from "@/service/overtime-request.service";
...
import { RejectedOvertimeTableHeadRow } from "./overtime-tab-table-heads";

export default function TabRejectedOvertimeRequests() {
  const t = useTranslations("operations.requests.overtime.tabs.rejected");
  ...
  const { data: rejectedRequestsData, isLoading } =
    useGetRejectedOvertimeRequests({
      page,
      pageSize,
      sort: "desc",
