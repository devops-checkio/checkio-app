...
function AttendanceConsentConfirmContent() {
  ...
  useEffect(() => {
    ...
    const processConfirmation = async () => {
      try {
        ...
        // Actualizar el estado local con la confirmación
        setData((prev) =>
          prev
            ? {
                ...prev,
        ...
        setError("Error al procesar el consentimiento");
      } finally {
        setLoading(false);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Confirmación de Consentimiento de Marcaje
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                El consentimiento de marcaje ha sido confirmado exitosamente
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 p-4 rounded-lg mb-4">
              ...
              <p className="text-xs leading-relaxed text-green-700">
                Este consentimiento ha sido registrado en nuestro sistema y será
            ...
            <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg mb-4">
              ...
              <ul className="text-xs text-orange-700 space-y-1">
                <li>• Se ha notificado al trabajador sobre la confirmación</li>
                <li>
            ...
            <div className="bg-purple-50 border border-purple-200 p-4 rounded-lg">
              ...
              <p className="text-purple-700 text-xs mt-1">
                Se ha procesado la confirmación del consentimiento de marcaje.
              </p>
            </div>
...
export default function AttendanceConsentConfirmPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex items-center justify-center">
    ...
    >
      <AttendanceConsentConfirmContent />
    </Suspense>
  );
}
