/** Document type enum - aligned with API */
...
/** Manager type - aligned with API */
export enum ManagerType {
  MANAGER = "MANAGER",
  SUPERVISOR = "SUPERVISOR",
}

/** Document type options for selects */
